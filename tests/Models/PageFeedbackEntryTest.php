...
class PageFeedbackEntryTest extends FunctionalTest
{
    ...
    public function testCmsComment()
    {
        ...
        $this->assertEquals('Hello World!', $withComment->getCmsComment());
        $this->assertEquals('<em>' . _t('VulcanPageFeedback.CMS_NO_COMMENT', 'No comment was provided..') . '</em>', $withoutComment->getCmsComment());
    }
}
